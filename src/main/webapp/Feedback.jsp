            ...
            <div class="main">
                <ul>                                            
                  ...
                  <div class="feedback">
					...
					<h1 style="margin: 0; padding: 0 0 20px; text-align: center; font-size: 22px">Feedback</h1>
					 <form action="FeedbackServlet" method="post">
						<input type="text" name="name" placeholder="Enter Your name" required><br>
						<input type="text" name="id" placeholder="Enter Your ID" required><br>
						<input type="text" name="email" placeholder="Enter Your email" required><br>
						<input type="text"  name="feedback" size="50" placeholder="Write Your Feedback" required>
